            ...
            <div class="me-2">
              ...
              <h6 class="card-subtitle text-muted">Decreto número: <span class="badge rounded-pill bg-info" ;><?php if(basename($_SERVER['SCRIPT_NAME']) == 'Diseño_decretos.php'){ include("Metodos/Obtiene_numero_decreto.php");} else { echo $decreto;}?></span><?php echo " del año " . $año; ?></small>
                        ...
                        <div class="card-body">
                                    ...
                                    <input type="text" required ="true" class="form-control fechaL" id="datepicker" name="datepicker" autocomplete="off" placeholder="Seleccione fecha">                                       
                                </div>

                                <div class="mb-3">
                                    <label for="exampleFormControlSelect1" class="form-label">FIRMA:</label>

                                        <select class="form-select selectJuezL" name="selectJuez" id="selectJuez" required>
                                ...
                                <div class="mb-3">
                                    <label for="exampleFormControlSelect1" class="form-label">CARGO:</label>
                                        ...
                                        <div class="position-relative">
                                            <select name="selectCargoVista" id="selectCargoVista" class="select2 form-select select2-hidden-accessible cargoL" disabled data-select2-id="select2Disabled" tabindex="-1" aria-hidden="true" style="cursor: not-allowed;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="txtEstadoL" id="txtEstadoL" required>                                                  
                                ...
                                <select class="form-control" id="selectFuncL" name="selectFuncL">
                                 <?php                         
                                ...
                                <input type="text" class="form-control desdeL" id="firstDate" name="firstDate" autocomplete="off" Required>
                                </div>
                                <div class="form-group">
                                <label for="exampleInputPassword1">Hasta</label>
                                <input type="text" class="form-control hastaL" id="secondDate" name="secondDate" autocomplete="off" Required>
                                </div>
                                <div class="form-group">
                                <label for="exampleInputPassword1">Dias / Jornada</label>
                                <input type="text" class="form-control diasL" id="days" name="days" autocomplete="off" Required>
                                </div>                          
                                <div class="form-group">
                                <label for="exampleInputPassword1">N° Documento</label>
                                <input type="text" class="form-control" id="txtdocumentoL" name="txtdocumentoL" autocomplete="off" Required>
                                </div>
                                <div class="form-group">
                                <label for="exampleInputPassword1">Fecha D.</label>
                                <input type="text" class="form-control fechaDilL" id="datepicker2" name="datepicker2" autocomplete="off" Required>
                                </div>
                                <div class="form-group">
                                <label for="exampleInputPassword1">Detalle</label>
                                <input type="text" class="form-control" id= "detalleLicenciasL"name ="detalleLicenciasL" autocomplete="off" Required>
                                ...
                                <input type="hidden" class="form-control" id="txtdecreL" name="txtdecreL" value="<?php echo $decreto;?>">            
                                <input type="hidden" class="form-control" id="txtTipo2L" name="txtTipo2L" value="<?php echo $decretotipo;?>">           
                    ...
                    <script src="../Assets/js/modificar/modificaLicencias.js"></script>