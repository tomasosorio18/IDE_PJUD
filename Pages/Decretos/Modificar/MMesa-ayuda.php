<div class="col-12 col-lg-4 order-2 order-md-3 order-lg-2 mb-2">
        ...
        <div class="d-flex">
          ...
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-1">
            <div class="me-2">
              <h5 class="card-title text-primary mb-3"> Decreto Mesa de ayuda</h5>
              <h6 class="card-subtitle text-muted">Decreto número: <span class="badge rounded-pill bg-info" ;><?php if(basename($_SERVER['SCRIPT_NAME']) == 'Diseño_decretos.php'){ include("Metodos/Obtiene_numero_decreto.php");} else { echo $decreto;}?></span><?php echo " del año " . $año; ?></small>
                        ...
                        <div class="card-body">
                                    ...
                                    <input type="text" required ="true" class="form-control fechaMA" id="datepicker" name="datepicker" autocomplete="off" placeholder="Seleccione fecha">                                       
                                </div>

                                <div class="mb-3">
                                    <label for="exampleFormControlSelect1" class="form-label">FIRMA:</label>

                                        <select class="form-select selectJuezMA" name="selectJuez" id="selectJuez" required>
                                ...
                                <div class="mb-3">
                                    <label for="exampleFormControlSelect1" class="form-label">CARGO:</label>
                                        ...
                                        <div class="position-relative">
                                            <select name="selectCargoVista" id="selectCargoVista" class="select2 form-select select2-hidden-accessible cargoMA" disabled data-select2-id="select2Disabled" tabindex="-1" aria-hidden="true" style="cursor: not-allowed;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="txtEstadoMA" id="txtEstadoMA" required>                                                  
                                ...
                                <input type="text" class="form-control" id= "detalleMAM" name ="detalleMAM" autocomplete="off" Required>
                                ...
                                <input type="hidden" class="form-control" id="txtdecreMA" name="txtdecreMA" value="<?php echo $decreto;?>">                     
                                <input type="hidden" class="form-control" id="txtTipo2MA" name="txtTipo2MA" value="<?php echo $decretotipo?>">            
                                <input type="hidden" class="form-control" id="turidMAM" name="turidMAM" value="<?php echo $tur_id?>">  
                    ...
                    <script src="../Assets/js/modificar/modificaMesaAyuda.js"></script>