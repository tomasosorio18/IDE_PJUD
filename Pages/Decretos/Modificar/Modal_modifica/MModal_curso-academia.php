...
<div class="modal fade" id="modalCurso-AcademiaM" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
                                ...
                                <input type="hidden" class="form-control" id="txtEstadoCAM" name="txtEstadoCAM">            
                                <input type="hidden" class="form-control" id="txtdecreCAM" name="txtdecreCAM" value="<?php echo $decreto?>">            
                                <input type="hidden" class="form-control" id="txtdata2CAM" name="txtdata2CAM">            
                                <input type="hidden" class="form-control" id="txtcargo2CAM" name="txtcargo2CAM">            
                                <input type="hidden" class="form-control" id="txtJuez2CAM" name="txtJuez2CAM">            
                                <input type="hidden" class="form-control" id="txtTipo2CAM" name="txtTipo2CAM"> 
