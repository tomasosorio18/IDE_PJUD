...
<div class="modal fade" id="modalPSM" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-body text-center"> 
                                ...
                                <p>Decreto de permisos-subrogancia modificado correctamente, presione el boton para generar un nuevo informe.</p>
                                <input type="hidden" class="form-control" id="txtEstadoPSM" name="txtEstadoPSM">            
                                <input type="hidden" class="form-control" id="txtdecrePSM" name="txtdecrePSM" value="<?php echo $decreto;?>">            
                                <input type="hidden" class="form-control" id="txtdata2PSM" name="txtdata2PSM">            
                                <input type="hidden" class="form-control" id="txtcargo2PSM" name="txtcargo2PSM" >            
                                <input type="hidden" class="form-control" id="txtJuez2PSM" name="txtJuez2PSM">            
                                <input type="hidden" class="form-control" id="txtTipo2PSM" name="txtTipo2PSM"> 
