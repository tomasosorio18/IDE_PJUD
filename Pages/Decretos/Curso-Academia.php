<div class="col-12 col-lg-4 order-2 order-md-3 order-lg-2 mb-2">
           ...
           <?php } ?>
                        ...
                        <div class="card-body">
                                 ...
                                 <option value='<?php echo $funcionarios["FUNCIONARIO_ID"] ?> '><?php echo $funcionarios["FUNCIONARIO_NOMBRE"]." ".$funcionarios["FUNCIONARIO_APELLIDO"];?></option> 
                                  ...
                                  <?php }?>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtCurso" name="txtCurso" autocomplete="off" Required>
                                   </div>
                                ...
                                <input type="text" class="form-control" id= "detalleCursoAcademia" name ="detalleCursoAcademia" autocomplete="off" Required>
                    ...
                    <script src="../Assets/js/insertaCursoAcademia.js"></script>