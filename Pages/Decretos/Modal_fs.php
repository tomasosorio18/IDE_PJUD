  ...
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
                                <h4>Generado!</h4>	 
                                <p>Decreto de feriados-subrogancia generado correctamente, presione el boton para generar un informe.</p> 
                                <input type="hidden" class="form-control" id="txtEstadoFSM" name="txtEstadoFSM" value="<?php echo $selectEstado ?>">            
                                <input type="hidden" class="form-control" id="txtdecreFSM" name="txtdecreFSM" value="<?php include("../Pages/Metodos/Obtiene_numero_decreto.php");?>">            
                                <input type="hidden" class="form-control" id="txtdata2FSM" name="txtdata2FSM" value="<?php echo $txtdate?>">            
                                <input type="hidden" class="form-control" id="txtcargo2FSM" name="txtcargo2FSM" value="<?php echo $selectCargo?>">            
                                <input type="hidden" class="form-control" id="txtJuez2FSM" name="txtJuez2FSM" value="<?php echo $selectJuez?>">            
                                <input type="hidden" class="form-control" id="txtTipo2FSM" name="txtTipo2FSM" value="<?php echo $decreto_tipo?>"> 
