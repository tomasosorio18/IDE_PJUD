<div class="col-12 col-lg-4 order-2 order-md-3 order-lg-2 mb-2">
        ...
        <div class="d-flex">
          ...
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-1">
            <div class="me-2">
              <h5 class="card-title text-primary mb-3">Permisos - Subrogacion</h5>
           ...
           <?php } ?>
                        ...
                        <div class="card-body">
                                ...
                                <input type="text" class="form-control" id= "detallePermisossubrogacion"name ="detallePermisossubrogacion" autocomplete="off" Required>
                                </div>
                                <br>
                    ...
                    <script src="../Assets/js/insertaPSubrogancia.js"></script>