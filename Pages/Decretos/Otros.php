          ...
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-1">
           ...
           <?php } ?>
                        ...
                        <div class="card-body">
                                ...
                                <input type="text" class="form-control" id= "detalleOtros" name ="detalleOtros" autocomplete="off" Required>
                                ...
                                <input type="hidden" class="form-control" id="turidO" name="turidO" value="<?php echo $tur_id?>">  
                    ...
                    <script src="../Assets/js/insertaOtros.js"></script>