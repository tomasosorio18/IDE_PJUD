          ...
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-1">
           ...
           <?php } ?>
                        ...
                        <div class="card-body">
                                ...
                                <input type="text" class="form-control" id= "detalleDesignacion" name ="detalleDesignacion" autocomplete="off" Required>
                    ...
                    <script src="../Assets/js/insertaDesignacion.js"></script>