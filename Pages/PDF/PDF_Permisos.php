<?php
// para mas detalle de como funciona el codigo de generar pdf vease pdfLicencias.php
include("../../Configuration/Connector.php");
require_once '../../Assets/vendor/autoload.php';

 if(isset($_POST['btnpdfP']))
{ if ((isset($_POST['txtcargo2PM']))?$_POST['txtcargo2PM']:"") {
    $selectCargo2 =(isset($_POST['txtcargo2PM']))?$_POST['txtcargo2PM']:"";
    try {
...
if ((isset($_POST['txtJuez2PM']))?$_POST['txtJuez2PM']:"") {
    $juezid =(isset($_POST['txtJuez2PM']))?$_POST['txtJuez2PM']:"";
    try {
...
if ((isset($_POST['txtdata2PM']))?$_POST['txtdata2PM']:"") {
    $txtdate2 = (isset($_POST['txtdata2PM']))?$_POST['txtdata2PM']:"";
    setlocale(LC_ALL,"es");
...
if ((isset($_POST['datepickerPM']))?$_POST['datepickerPM']:"") {
    $txtdate2 = (isset($_POST['datepickerPM']))?$_POST['datepickerPM']:"";
    setlocale(LC_ALL,"es");
    $fechaSTR= strftime("%A, %d de %B de %Y", strtotime($txtdate2));
    $strFinal= ucfirst(iconv("ISO-8859-1","UTF-8",$fechaSTR));
}else{
...
if ((isset($_POST['txtTipo2PM']))?$_POST['txtTipo2PM']:"") {
    $selectDecreto2 = (isset($_POST['txtTipo2PM']))?$_POST['txtTipo2PM']:"";
}else{
    $selectDecreto2= "Default";
}


if ((isset($_POST['txtdecrePM']))?$_POST['txtdecrePM']:"") {
    $decrenumber =(isset($_POST['txtdecrePM']))?$_POST['txtdecrePM']:"";
}else{
    $decrenumber= "?";
}
if ((isset($_POST['funcionarioPM']))?$_POST['funcionarioPM']:""){
    $funcionarioid =(isset($_POST['funcionarioPM']))?$_POST['funcionarioPM']:"";
    try {
...
if ((isset($_POST['desdePM']))?$_POST['desdePM']:"") {
    $firstDate =(isset($_POST['desdePM']))?$_POST['desdePM']:"";
}else{
    $firstDate= "";
}
if ((isset($_POST['dpPM']))?$_POST['dpPM']:"") {
    $fechaD=(isset($_POST['dpPM']))?$_POST['dpPM']:"";
}else{
    $fechaD= "";
}

if ((isset($_POST['hastaPM']))?$_POST['hastaPM']:"") {
    $secondDate =(isset($_POST['hastaPM']))?$_POST['hastaPM']:"";
}else{
    $secondDate= "";
}
if ((isset($_POST['diasPM']))?$_POST['diasPM']:"") {
    $days =(isset($_POST['diasPM']))?$_POST['diasPM']:"";
}else{
    $days= "";
}
if ((isset($_POST['ndocumentoPM']))?$_POST['ndocumentoPM']:"") {
    $txtdocumento =(isset($_POST['ndocumentoPM']))?$_POST['ndocumentoPM']:"";
}else{
    $txtdocumento= "";
}
...
$año = date("Y");
    try {
        ...
        $mpdf->setSourceFile('../../Assets/plantillas/PERMISO_CLS1.pdf'); // absolute path to pdf file
...
// contiene varias opciones, desde descargar, forzar descarga, o el mismo inline, vease la documentacion de OUTPUT DE MPDF
    ...
    try {
        ...
        $filename = uniqid(mt_rand(), true) . " - " ."Decreto_Permisos_N".$decrenumber."-".$año.".pdf";
