...
<?php $PageTitle="Gestion de cargos de funcionarios";
...
try {
    $sentenciaSQL=$conexion->prepare("SELECT cargo_funcionario.CARGO_FUNC_NOMBRE, COUNT(funcionario.CARGO_FUNC_ID) as cantidad, cargo_funcionario.CARGO_FUNC_ID AS cargoid 
    FROM cargo_funcionario
    LEFT JOIN funcionario ON funcionario.CARGO_FUNC_ID = cargo_funcionario.CARGO_FUNC_ID
    WHERE funcionario.FUNCIONARIO_FECHA_BAJA IS NULL AND cargo_funcionario.CARGO_FECHA_BAJA IS NULL
    GROUP BY cargo_funcionario.CARGO_FUNC_NOMBRE, cargo_funcionario.CARGO_FUNC_ID
...
<?php include("Modales_general/Modal_agrega_cargo_funcionario.php");?>
<?php include("Modales_general/Modal_exito.php");?>



<div class="row">
                      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Gestion de cargos /</span> Gestion de cargos de funcionarios</h4>
                        ...
                        <div class="col-12 col-lg-4 order-2 order-md-3 order-lg-2 mb-2">
                            <div class="card" style="word-wrap: break-word;">
                                <div class="d-flex align-items-end row">      
                                    <div class="col-md-11">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary"><?php echo $cargos["CARGO_FUNC_NOMBRE"];?></h5>
                                                 ...
                                                 <h6 class="card-subtitle text-muted">Actualmente con <?php echo $cargos['cantidad'] . " miembro(s)."; ?></h6>
                                                     ...
                                                     <?php include("Metodos/Trae_funcionarios_por_cargo.php"); ?>
                                                </div>
                                                </div>
                                        <div class="card-body">
                                        <input type="hidden" id="cargo_nombre" value="<?php echo $cargos["CARGO_FUNC_NOMBRE"];?>">
                                        <span class="badge rounded-pill bg-label-warning mb-2" style="text-align: center;white-space: pre-wrap;line-height: 1.5;">Para dar de baja un cargo asegurese de que el cargo no tenga miembros activos.</span> <span class="badge rounded-pill bg-label-danger mb-5"style="text-align: center;white-space: pre-wrap;line-height: 1.5;"><b>¡De lo contrario, se dara de baja el o los funcionarios pertenecientes!</b> </span>
                                ...
                                <?php include("Modales_general/Modal_edita_cargo_funcionario.php");?> 
                                <?php include("Modales_general/Modal_borra_cargo_funcionario.php");?> 
                           </div>
                        </div>  
                                ...
                                <div class="d-flex align-items-end row">      
                                    <div class="col-md-11">
                                            <div class="card-body">
                                                ...
                                                <h6 class="card-subtitle text-muted">¡Presiona el boton de abajo para agregar un cargo de funcionario nuevo!</h6>
                                                </div>
                                        <div class="card-body">
...
<script src="../Assets/js/cargo_funcionario/modificaCargoFuncionario.js"></script>   
<script src="../Assets/js/cargo_funcionario/borraCargoFuncionario.js"></script>                   
