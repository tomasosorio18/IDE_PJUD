...
WHERE decreto.DECRETO_ANIO = :DECRETO_ANIO AND tribunal_usu_rol.TRIBUNAL_ID = :TRIBUNAL_ID
                            ...
                            <tbody>
                                <?php foreach($listaDecretos as $decretos){ ?>
                                    <tr >
                                        ...
                                        <td><?php echo $decretos['FUNCIONARIO_NOMBRE']. " ". $decretos['FUNCIONARIO_APELLIDO'];?></td>
                                      ...
                                      ?></td>
                                        ...
                                        <td> 
                                                        <!-- preguntamos si el detalle es igual a anulado, si es asi no lo mostramos -->
                                                        <?php  $detalle = $decretos['DECRETO_DETALLE'];
                                                    if ($detalle == "ANULADO") {?>
                                                        <a href="#"><span class="glyphicon glyphicon-edit"></span><img src="../Assets/images/cancelar_gris.png" style="width: 40px; height: 40px; margin-left:30px;" alt=""></a>
                                                <?php }else{?>
                                                        <a href="#" data-bs-target="#anular_<?php echo $decretos['DECRETO_N_CORRELATIVO']; ?>" data-bs-toggle="modal"><span class="glyphicon glyphicon-edit"></span><img src="../Assets/images/cancelar.png" style="width: 40px; height: 40px; margin-left:30px;" alt=""></a>
                                                    <?php } ?>
                                                    ...
                                                    <?php include('Adjuntos/Modal_AI_Admin.php'); ?>  
                                                    <?php include('Adjuntos/Modal_AF_Admin.php'); ?>
