...
if ((isset($_POST['turidCA']))?$_POST['turidCA']:"") {
    $turidCA = (isset($_POST['turidCA']))?$_POST['turidCA']:"";
}else{
    $turidCA= "Default";
}

if ((isset($_POST['detalleCursoAcademia']))?$_POST['detalleCursoAcademia']:"") {
    $detalleCursoAcademia =(isset($_POST['detalleCursoAcademia']))?$_POST['detalleCursoAcademia']:"";
}else{
   ...
   echo "3";
    ...
    try {
        $sentenciaSQL=$conexion->prepare(
            ...
            $sentenciaSQL->bindParam(':TUR_ID',$turidCA);
            $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detalleCursoAcademia,PDO::PARAM_STR);
