...
if ((isset($_POST['turidF']))?$_POST['turidF']:"") {
    $turidF = (isset($_POST['turidF']))?$_POST['turidF']:"";
}else{
    $turidF= "Default";
}
...
if ((isset($_POST['detalleFeriados']))?$_POST['detalleFeriados']:"") {
    $detalleFeriados =(isset($_POST['detalleFeriados']))?$_POST['detalleFeriados']:"";
}else{
...
if ((isset($_POST['selectFunc']))?$_POST['selectFunc']:""){
    ...
    try {
            ...
            $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detalleFeriados,PDO::PARAM_STR);
            $sentenciaSQL->bindParam(':TUR_ID',$turidF);
        ...
        echo $decrenumber . " ". $selectJuez2 ." ". $selectDecreto2 ." ". $txtdate2 ." ". $txtFunc ." ". $detalleFeriados ." ". $turidF ." ". $INICIALES ." ".$txtEstado ." ".$año;
    }
