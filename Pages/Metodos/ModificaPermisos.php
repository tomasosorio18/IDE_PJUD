...
if ((isset($_POST['turidP']))?$_POST['turidP']:"") {
    $turidP = (isset($_POST['turidP']))?$_POST['turidP']:"";
}else{
    $turidP= "Default";
}
...
if ((isset($_POST['detallePermisosP']))?$_POST['detallePermisosP']:"") {
    $detallePermisos =(isset($_POST['detallePermisosP']))?$_POST['detallePermisosP']:"";
}else{
    $detallePermisos= "Default";
}
...
if ((isset($_POST['selectFunc']))?$_POST['selectFunc']:""){
    ...
    try {
            ...
            $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detallePermisos,PDO::PARAM_STR);
            $sentenciaSQL->bindParam(':TUR_ID',$turidP); 
        ...
        echo $decrenumber . " ". $selectJuez2 ." ". $selectDecreto2 ." ". $txtdate2 ." ". $txtFunc ." ". $detallePermisos ." ". $turidP ." ". $INICIALES ." ".$txtEstado ." ".$año;
    }
