...
if ((isset($_POST['turidPS']))?$_POST['turidPS']:"") {
    $turidPS= (isset($_POST['turidPS']))?$_POST['turidPS']:"";
}else{
    $turidPS= "Default";
}
...
if ((isset($_POST['detallePermisossubrogacionPS']))?$_POST['detallePermisossubrogacionPS']:"") {
    $detallePS =(isset($_POST['detallePermisossubrogacionPS']))?$_POST['detallePermisossubrogacionPS']:"";
}else{
    $detallePS= "Default";
}
...
if ((isset($_POST['txtdecre']))?$_POST['txtdecre']:"") {
    ...
    try {
            ...
            $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detallePS,PDO::PARAM_STR);
            $sentenciaSQL->bindParam(':TUR_ID',$turidPS);
        ...
        echo $decrenumber . " ". $selectJuez2 ." ". $selectDecreto2 ." ". $txtdate2 ." ". $txtAusente ." ". $detallePS ." ". $turidPS ." ". $INICIALES ." ".$txtEstado ." ".$año;
    }
