...
if ((isset($_POST['turidCAM']))?$_POST['turidCAM']:"") {
    $turidCAM = (isset($_POST['turidCAM']))?$_POST['turidCAM']:"";
}else{
    $turidCAM= "Default";
}

if ((isset($_POST['detalleCursoAcademia']))?$_POST['detalleCursoAcademia']:"") {
    $detalleCAM =(isset($_POST['detalleCursoAcademia']))?$_POST['detalleCursoAcademia']:"";
}else{
    $detalleCAM= "Default";
}
...
try {
    ...
    $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detalleCAM,PDO::PARAM_STR);
    $sentenciaSQL->bindParam(':TUR_ID',$turidCAM);
...
echo $decrenumber . " ". $selectJuez2 ." ". $selectDecreto2 ." ". $txtdate2 ." ". $txtFunc ." ". $detalleCAM ." ". $turidCAM ." ". $INICIALES ." ".$txtEstado ." ".$año;
}
