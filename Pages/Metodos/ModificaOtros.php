...
if ((isset($_POST['turidO']))?$_POST['turidO']:"") {
    $turidO = (isset($_POST['turidO']))?$_POST['turidO']:"";
}else{
    $turidO= "Default";
}
...
if ((isset($_POST['detalleOtros']))?$_POST['detalleOtros']:"") {
    $detalleOtros =(isset($_POST['detalleOtros']))?$_POST['detalleOtros']:"";
}else{
    $detalleOtros= "Default";
}
...
if ((isset($_POST['selectFunc']))?$_POST['selectFunc']:""){
   ...
   try {
    $sentenciaSQL=$conexion->prepare(
        ...
        $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detalleOtros,PDO::PARAM_STR);
        $sentenciaSQL->bindParam(':TUR_ID',$turidO);
    ...
    echo $decrenumber . " ". $selectJuez2 ." ". $selectDecreto2 ." ". $txtdate2 ." ". $detalleOtros ." ". $turidO ." ". $INICIALES ." ".$txtEstado ." ".$año;
   }
