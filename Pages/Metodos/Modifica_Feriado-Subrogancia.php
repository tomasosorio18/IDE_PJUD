...
if ((isset($_POST['turidFS']))?$_POST['turidFS']:"") {
    $turidFS= (isset($_POST['turidFS']))?$_POST['turidFS']:"";
}else{
    $turidFS= "Default";
}
...
if ((isset($_POST['detalleFeriadossubrogacion']))?$_POST['detalleFeriadossubrogacion']:"") {
    $detalleFS =(isset($_POST['detalleFeriadossubrogacion']))?$_POST['detalleFeriadossubrogacion']:"";
}else{
    $detalleFS= "Default";
}
...
if ((isset($_POST['txtdecre']))?$_POST['txtdecre']:"") {
    ...
    try {
            ...
            $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detalleFS,PDO::PARAM_STR);
            $sentenciaSQL->bindParam(':TUR_ID',$turidFS);
        ...
        echo $decrenumber . " ". $selectJuez2 ." ". $selectDecreto2 ." ". $txtdate2 ." ". $txtAusente ." ". $detalleFS ." ". $turidFS ." ". $INICIALES ." ".$txtEstado ." ".$año;
    }
