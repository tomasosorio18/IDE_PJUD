...
if ((isset($_POST['detallePermisos']))?$_POST['detallePermisos']:"") {
    $detallePermisos = (isset($_POST['detallePermisos']))?$_POST['detallePermisos']:"";
}else{
...
if ($isDecretoExists) {
   echo "3";
    ...
    try {
            ...
            $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detallePermisos);
