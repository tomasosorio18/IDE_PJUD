...
if ((isset($_POST['turidD']))?$_POST['turidD']:"") {
    $turidD = (isset($_POST['turidD']))?$_POST['turidD']:"";
}else{
    $turidD= "Default";
}

if ((isset($_POST['detalleDesignacion']))?$_POST['detalleDesignacion']:"") {
    $detalleDesignacion =(isset($_POST['detalleDesignacion']))?$_POST['detalleDesignacion']:"";
}else{
    $detalleDesignacion= "Default";
}
   ...
   echo "3";
    ...
    try {
        $sentenciaSQL=$conexion->prepare(
            ...
            $sentenciaSQL->bindParam(':TUR_ID',$turidD,PDO::PARAM_STR);
            $sentenciaSQL->bindParam(':DECRETO_DETALLE',$detalleDesignacion,PDO::PARAM_STR);
