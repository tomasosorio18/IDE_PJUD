...
if ((isset($_POST['detallePermisossubrogacion']))?$_POST['detallePermisossubrogacion']:"") {
    $detallePS =(isset($_POST['detallePermisossubrogacion']))?$_POST['detallePermisossubrogacion']:"";
}else{
    $detallePS= "Default";
}
   ...
   echo "3";
    ...
    try { 
        $sentenciaSQL=$conexion->prepare(
            ...
            $sentenciaSQL->bindParam(':TUR_ID',$turidPS,PDO::PARAM_STR);
