      ...
      <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
              ...
              <ul class="menu-inner py-1">
                <!-- Dashboard -->
                <li class="<?php if(basename($_SERVER['SCRIPT_NAME']) == 'Home-usuario.php'){echo 'menu-item active'; }else { echo 'menu-item'; } ?>">
                  <a href="Home-usuario.php" class="menu-link">
                ...
                <li class="<?php if(basename($_SERVER['SCRIPT_NAME']) == 'Diseño_decretos.php' or basename($_SERVER['SCRIPT_NAME']) == 'Informe_decretos.php' or basename($_SERVER['SCRIPT_NAME']) == 'Modificar_decretos.php' or basename($_SERVER['SCRIPT_NAME']) == 'Subir_decretos.php'){echo 'menu-item active'; }else { echo 'menu-item'; } ?>">
                  ...
                  <ul class="menu-sub">
                    ...
                    <li class="<?php if(basename($_SERVER['SCRIPT_NAME']) == 'Informe_decretos_usuario.php'){echo 'menu-item active'; }else { echo 'menu-item'; } ?>">
                      <a href="Informe_decretos_usuario.php" class="menu-link">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <a class="dropdown-item" href="Perfil.php">
                          ...
                          <span class="badge bg-label-primary me-1"><?php if ($rol == 1){ echo "Administrador";}else{ echo "Usuario";};?></span>
                            </div>
                          </div>
                        </a>
                      </li>
