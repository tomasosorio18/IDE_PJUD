...
<?php 
                  ...
                  include("Metodos/Obtiene_decretos.php.");
...
$('#table').DataTable({
    dom: 'Bfrtip',
        buttons: [
            {
                extend: 'excelHtml5', text: 'Generar archivo excel',  
                className:"btn rounded-pill btn-label-primary",
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 6, 8, 10, 11, 12 ]
                }
            },
            'colvis'
        ],
