      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
         <div class="card-body">
            ...
            <p class="mb-4">
              Actualmente usted posee el rol de <span class="badge bg-label-warning me-1">Administrador</span> 
            </p>
            <p>Si desea asignar a otro usuario como administrador puede probar el menu de roles! </p>
            <a href="Gestion_roles.php" class="btn rounded-pill btn-label-warning" style="height: 50px;">Administrar roles</a>
      ...
      <div class="d-flex align-items-end row">
        ...
        <div class="card-header d-flex justify-content-between">
                                              <div class="card-title mb-0">
                                                 <h5 class="card-title text-primary">Decretos sin firmar</h5>
                                             
                                              </div>
                                           </div>
         <div class="card-body">
                                     
         <?php include("Metodos/Obtiene_decretos_sin_firmar.php");?>                    
          </div>
        </div>
