    ...
    <div class="modal-dialog modal-confirm">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <h4>Dar de baja un cargo de juez.</h4>	
          <input type="hidden" class ="borraCargoid" id="borraCargoid" name="borracargoid" value="<?php echo $cargos["cargoid"]; ?>">
            ...
            "<b style="white-space: pre-wrap;line-height: 1.5;"><?php echo $cargos["CARGO_JUEZ_NOMBRE"];?></b>"<br>junto con todos los jueces pertenecientes al cargo, ¿Esta seguro?
            </div>
        <br>
