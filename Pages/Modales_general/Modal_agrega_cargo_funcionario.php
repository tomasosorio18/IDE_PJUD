    ...
    <div class="modal-dialog modal-confirm">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          <h4>Agregar un nuevo cargo de funcionario</h4>	
        
            <div class="alert alert-primary">
            ¡Eliga un nombre para su nuevo cargo de funcionario!
            </div>
            <div class="row g-3">
              <div class="d-flex align-items-center justify-content-center">
                <div class="col-md-6"> 
                    <label class="form-label" for="formtabs-first-name">Nombre del cargo del funcionario:</label>
        ...
        <br>
          ...
          <button type="text" class="btn rounded-pill btn-primary" name="agregacargofuncionario" id="agregacargofuncionario"><span> Agregar</span></a>
        </div>
      </div>
    </div>
  </div>     

  <script src="../Assets/js/cargo_funcionario/insertaCargoFuncionario.js"></script>   